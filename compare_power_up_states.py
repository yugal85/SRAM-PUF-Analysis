...
# Read the hex data from the files
file_path1 = '/Users/yugalsingam/Documents/puf1.txt'
file_path2 = '/Users/yugalsingam/Documents/puf2.txt'
...
print(f"Total number of '1' bits in puf1: {total_ones1}")
print(f"Total number of '0' bits in puf1: {total_zeros1}")
print(f"Total number of '1' bits in puf2: {total_ones2}")
print(f"Total number of '0' bits in puf2: {total_zeros2}")
